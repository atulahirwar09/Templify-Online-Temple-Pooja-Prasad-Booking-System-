              ...
              <div class="container1">
                <form action="#" class="otp-Form" method="post">
                  ...
                  <div class="inputContainer">
                    <input required maxlength="1" type="text" name="num1" class="otp-input" autofocus autocomplete="off" oninput="handleInput(event, document.getElementById('otp2'))">
                    <input required maxlength="1" type="text" name="num2" class="otp-input" id="otp2" autocomplete="off" oninput="handleInput(event, document.getElementById('otp3'))">
                  ...
                  <button class="verifyButton" id="otp_btn" type="button">Verify</button>
...
<script> 
  let otp_btn = document.querySelector('#otp_btn');
  const correctOTP = <c:out value="${trustee.otp}" /> // Replace with your actual OTP
  ...
  otp_btn.addEventListener('click',()=> {
    const enteredOTP = Array.from(document.querySelectorAll('.otp-input')).map(input => input.value).join('');
      ...
      if (enteredOTP === correctOTP) {
        window.location = "otp_verify.do"; // Replace this with your desired action
                
      } else {
        document.getElementById('error-message').textContent = 'Incorrect OTP. Please try again.';
        clearOTPInputs();
      }
  });
