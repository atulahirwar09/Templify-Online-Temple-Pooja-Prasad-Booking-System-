    ...
    <div class="container">
        <div class="row mt-2 p-3">
            <div class="col-sm-6 d-grid">
                <a href="t_add_pooja.do" class="btn btn-outline-info rounded-pill py-3" type="submit">ADD POOJA</a>
            </div>
            <div class="col-sm-6 d-grid">
                <a href="t_manage_pooja.do" class="btn btn-outline-info rounded-pill py-3" type="submit">MANAGE POOJA</a>
            </div>
        </div>
        <div>
          <div class="row mt-4">
        ...
        <c:if test="${!poojaData.isEmpty()}">
                  ...
                  <div id="btn_${x.count}" class="accordion-collapse collapse" aria-labelledby="heading_${x.count}" data-bs-parent="#parent_accordion">
                    <div class="accordion-body">
                      ...
                      <div class="p-3 bg-light">
                        ...
                        <div class="row mt-3">
                          <div class="border border-dark  p-2 rounded-start col-6">
                            <b>Prasad Name : </b>
                            <c:out value="${pd.prasadId.name}" />
                          </div>
                          <div class="border border-dark  p-2 col-3">
                            <b>Quantity : </b>
                            <c:out value="${pd.prasadId.quantity}" />
                          </div>
                          <div class="border border-dark  p-2 rounded-end col-3">
                            <b>Amount : </b>
          ...
          <p class="text-center mt-4">
            <a href="t_manage_pooja.do" class="btn btn-outline-secondary w-25">See All</a>
          </p>
        </c:if>
